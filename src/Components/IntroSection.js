...
const IntroSection = () => {
  ...
  return (
    <section className=" intro-section  md:flex md:flex-row-reverse md:justify-between " id="home"> 
      ...
      <div className=" text-center px-9 md:px-0 md:ml- md:text-left md:ml-36 intro-body">
        <h1 className="text-4xl font-medium text-DarkBlue leading-tight mb-4  md:text-5xl">Next generation digital banking</h1>
